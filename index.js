...
if (args[2] == '-h' || args[2] == '--help') {
    ...
    console.log('Description: Command will read .env file and generate env-config.json file based on .env file content');
    console.log('Sample output file:');
    ...
    if (!fs.existsSync('.env')) {
        ...
        console.log('env-config.json file is succesfully created');
    }
